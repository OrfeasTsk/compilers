...
define i32 @TV.Start(i8* %this) {
    ...
    store i32 0, i32* %nti
    %v = alloca i8*
    %_1 = call i8* @calloc(i32 0, i32 24)
    store i8* %_1, i8** %v
    %_2 = call i8* @calloc(i32 1, i32 38)
    %_3 = bitcast i8* %_2 to i8**
    %_4 = getelementptr [21 x i8*], [21 x i8*]* @.Tree_vtable, i32 0, i32 0
    ...
    %_13 = call i8 %_12(i8* %_6, i32 16)
    store i8 %_13, i8* %ntb
    %_14 = load i8*, i8** %root
    %_15 = bitcast i8* %_14 to i8**
    %_16 = load i8*, i8** %_15
    %_17 = getelementptr i8, i8* %_16, i32 144
    %_18 = bitcast i8* %_17 to i8**
    %_19 = load i8*, i8** %_18
    %_20 = bitcast i8* %_19 to i8 (i8*)*
    %_21 = call i8 %_20(i8* %_14)
    store i8 %_21, i8* %ntb
    call void (i32) @print_int(i32 100000000)
    %_22 = load i8*, i8** %root
    %_23 = bitcast i8* %_22 to i8**
    %_24 = load i8*, i8** %_23
    %_25 = getelementptr i8, i8* %_24, i32 96
    %_26 = bitcast i8* %_25 to i8**
    %_27 = load i8*, i8** %_26
    %_28 = bitcast i8* %_27 to i8 (i8*, i32)*
    %_29 = call i8 %_28(i8* %_22, i32 8)
    store i8 %_29, i8* %ntb
    %_30 = load i8*, i8** %root
    %_31 = bitcast i8* %_30 to i8**
    %_32 = load i8*, i8** %_31
    %_33 = getelementptr i8, i8* %_32, i32 96
    %_34 = bitcast i8* %_33 to i8**
    %_35 = load i8*, i8** %_34
    %_36 = bitcast i8* %_35 to i8 (i8*, i32)*
    %_37 = call i8 %_36(i8* %_30, i32 24)
    store i8 %_37, i8* %ntb
    %_38 = load i8*, i8** %root
    %_39 = bitcast i8* %_38 to i8**
    %_40 = load i8*, i8** %_39
    %_41 = getelementptr i8, i8* %_40, i32 96
    %_42 = bitcast i8* %_41 to i8**
    %_43 = load i8*, i8** %_42
    %_44 = bitcast i8* %_43 to i8 (i8*, i32)*
    %_45 = call i8 %_44(i8* %_38, i32 4)
    store i8 %_45, i8* %ntb
    %_46 = load i8*, i8** %root
    %_47 = bitcast i8* %_46 to i8**
    %_48 = load i8*, i8** %_47
    %_49 = getelementptr i8, i8* %_48, i32 96
    %_50 = bitcast i8* %_49 to i8**
    %_51 = load i8*, i8** %_50
    %_52 = bitcast i8* %_51 to i8 (i8*, i32)*
    %_53 = call i8 %_52(i8* %_46, i32 12)
    store i8 %_53, i8* %ntb
    %_54 = load i8*, i8** %root
    %_55 = bitcast i8* %_54 to i8**
    %_56 = load i8*, i8** %_55
    %_57 = getelementptr i8, i8* %_56, i32 96
    %_58 = bitcast i8* %_57 to i8**
    %_59 = load i8*, i8** %_58
    %_60 = bitcast i8* %_59 to i8 (i8*, i32)*
    %_61 = call i8 %_60(i8* %_54, i32 20)
    store i8 %_61, i8* %ntb
    %_62 = load i8*, i8** %root
    %_63 = bitcast i8* %_62 to i8**
    %_64 = load i8*, i8** %_63
    %_65 = getelementptr i8, i8* %_64, i32 96
    %_66 = bitcast i8* %_65 to i8**
    %_67 = load i8*, i8** %_66
    %_68 = bitcast i8* %_67 to i8 (i8*, i32)*
    %_69 = call i8 %_68(i8* %_62, i32 28)
    store i8 %_69, i8* %ntb
    %_70 = load i8*, i8** %root
    %_71 = bitcast i8* %_70 to i8**
    %_72 = load i8*, i8** %_71
    %_73 = getelementptr i8, i8* %_72, i32 96
    %_74 = bitcast i8* %_73 to i8**
    %_75 = load i8*, i8** %_74
    %_76 = bitcast i8* %_75 to i8 (i8*, i32)*
    %_77 = call i8 %_76(i8* %_70, i32 14)
    store i8 %_77, i8* %ntb
    %_78 = load i8*, i8** %root
    %_79 = bitcast i8* %_78 to i8**
    %_80 = load i8*, i8** %_79
    %_81 = getelementptr i8, i8* %_80, i32 144
    ...
    store i8 %_85, i8* %ntb
    call void (i32) @print_int(i32 100000000)
    %_86 = call i8* @calloc(i32 1, i32 24)
    %_87 = bitcast i8* %_86 to i8**
    %_88 = getelementptr [1 x i8*], [1 x i8*]* @.MyVisitor_vtable, i32 0, i32 0
...
label0:
    ...
    %_12 = bitcast i8* %_11 to i8**
    %_13 = load i8*, i8** %_12
    %_14 = getelementptr i8, i8* %_13, i32 24
    %_15 = bitcast i8* %_14 to i8**
    %_16 = load i8*, i8** %_15
    ...
    %_22 = bitcast i8* %_21 to i8**
    %_23 = load i8*, i8** %_22
    %_24 = getelementptr i8, i8* %_23, i32 160
    %_25 = bitcast i8* %_24 to i8**
    %_26 = load i8*, i8** %_25
    %_27 = bitcast i8* %_26 to i32 (i8*, i8*)*
    %_28 = call i32 %_27(i8* %_21, i8* %this)
    store i32 %_28, i32* %nti
    br label %label2
...
label2:
    ...
    %_30 = bitcast i8* %_29 to i8**
    %_31 = load i8*, i8** %_30
    %_32 = getelementptr i8, i8* %_31, i32 64
    %_33 = bitcast i8* %_32 to i8**
    %_34 = load i8*, i8** %_33
...
label3:
    ...
    %_41 = bitcast i8* %_40 to i8**
    %_42 = load i8*, i8** %_41
    %_43 = getelementptr i8, i8* %_42, i32 32
    %_44 = bitcast i8* %_43 to i8**
    %_45 = load i8*, i8** %_44
    %_46 = bitcast i8* %_45 to i8* (i8*)*
    %_47 = call i8* %_46(i8* %_40)
    ...
    %_51 = bitcast i8* %_50 to i8**
    %_52 = load i8*, i8** %_51
    %_53 = getelementptr i8, i8* %_52, i32 160
    %_54 = bitcast i8* %_53 to i8**
    %_55 = load i8*, i8** %_54
    %_56 = bitcast i8* %_55 to i32 (i8*, i8*)*
    %_57 = call i32 %_56(i8* %_50, i8* %this)
    store i32 %_57, i32* %nti
    br label %label5
...
label3:
    ...
    %_49 = bitcast i8* %_48 to i8**
    %_50 = load i8*, i8** %_49
    %_51 = getelementptr i8, i8* %_50, i32 32
    %_52 = bitcast i8* %_51 to i8**
    %_53 = load i8*, i8** %_52
    %_54 = bitcast i8* %_53 to i8* (i8*)*
    %_55 = call i8* %_54(i8* %_48)
    ...
    %_59 = bitcast i8* %_58 to i8**
    %_60 = load i8*, i8** %_59
    %_61 = getelementptr i8, i8* %_60, i32 160
    %_62 = bitcast i8* %_61 to i8**
    %_63 = load i8*, i8** %_62
    %_64 = bitcast i8* %_63 to i32 (i8*, i8*)*
    %_65 = call i32 %_64(i8* %_58, i8* %this)
    store i32 %_65, i32* %nti
    br label %label5
